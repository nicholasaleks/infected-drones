...
| [MAVSDK-02](MAVSDK-02_camera_cam_definition_ssrf_traversal/) | MAVSDK | 🟠 HIGH | 22/73/918 | cam-definition SSRF + `mftp://` traversal → **zero-click destruction of a file outside the sandbox** | push (CAMERA_INFORMATION.cam_definition_uri, auto) | ✅ | ✅ most natural (camera) | ✅ | ✅ | ✅ | ✅ auto-consumed push | ✅ | pending |
